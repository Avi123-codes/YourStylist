...
const prompt = ai.definePrompt({
    ...
    3.  For each selected item, provide a descriptive name (e.g., "Black Leather Loafers", "Striped Cotton T-Shirt") and its category.
    4.  Provide a brief reasoning for your outfit selection. Explain why the items work well together for the given occasion.
    5.  It is crucial that you only use the items provided in the images. Do not invent new items.
    `,
});
