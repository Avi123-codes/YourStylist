...
import { Home, Scissors, Shirt, Star, User, Bot, Sparkles, GalleryHorizontal } from 'lucide-react';
...
export function MainNav() {
  ...
  const menuItems = [
    ...
    { href: '/dashboard/closet', label: 'Digital Closet', icon: GalleryHorizontal },
  ];
